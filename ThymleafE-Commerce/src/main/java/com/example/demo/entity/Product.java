...
public class Product {	
	...
	public float getUnit_prcie() {
		return unit_price;
	}

	public void setUnit_prcie(float unit_prcie) {
		this.unit_price = unit_prcie;
	}
	...
	public String toString() {
		return "Product [product_id=" + product_id + ", product_name=" + product_name + ", description=" + description
				+ ", unit_prcie=" + unit_price + ", image_url=" + image_url + ", units_in_stock=" + units_in_stock
